...
#define  MAX_LEADER_PITCH    0.25 * M_PI
#define  MIN_LEADER_PITCH   -0.25 * M_PI
...
:
    ...
    m_fVelYaw(0.0f),
    m_fVelPitch(0.0f),
    m_oCamera(60.0f, 800.0f/600.0f, 0.5f, 10000.0f)
{
...
:
    ...
    m_fVelYaw(0.0f),
    m_fVelPitch(0.0f),
    m_oCamera(60.0f, 800.0f/600.0f, 0.5f, 2500.0f)
{
    printf("Creating LeaderBoid: %s\n", cpName);
}
...
void LeaderBoid::update(float dt)
{
    ...
    m_oCamera.setPosition(m_vfTranslate - vDist*5.0f - m_vfVelocity*0.1f + float3::UNIT_Y);
